...
<ul>
  ...
  <li><strong>CI/CD Automation:</strong> GitHub Actions builds and tests the app, runs Trivy security scans and SonarQube quality checks, then pushes Docker images to ECR, updates ECS task definitions, and triggers CodeDeploy Blue/Green deployments.</li>
